...
from .views import ComplaintListCreateView, ComplaintDetailView, UpvoteToggleView, AdminComplaintListView, StatusUpdateView, HeatmapView, AdminSummaryView, BulkStatusUpdateView, AdminTrendsView, AdminUserListView, AdminUserUpdateView, AdminUserComplaintsView
...
urlpatterns = [
    ...
    path('admin/users/<int:pk>/complaints/', AdminUserComplaintsView.as_view()),
]
